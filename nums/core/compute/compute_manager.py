...
class ComputeManager(ComputeInterface):
    ...
    def put(self, value: Any, **kwargs):
        ...
        return self.system.put(value, device)
    ...
    def call(self, name: str, *args, **kwargs):
        ...
        del kwargs["syskwargs"]
        device, options = self._process_syskwargs(syskwargs)
        return self.system.call(name, args, kwargs, device, options)
    ...
    def make_actor(self, name: str, *args, device: Device = None, **kwargs):
        return self.system.make_actor(name, *args, device=device, **kwargs)
