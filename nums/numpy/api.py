...
def all(a: BlockArray, axis=None, out=None, keepdims=False, dtype=None):
    if out is not None:
        raise NotImplementedError("'out' is currently not supported.")
    return _instance().reduce("all", a, axis=axis, keepdims=keepdims, dtype=dtype)
...
def any(a: BlockArray, axis=None, out=None, keepdims=False, dtype=None):
    if out is not None:
        raise NotImplementedError("'out' is currently not supported.")
    return _instance().reduce("any", a, axis=axis, keepdims=keepdims, dtype=dtype)
...
def array_equal(a1: BlockArray, a2: BlockArray, equal_nan=False) -> BlockArray:
    if equal_nan is not False:
        raise NotImplementedError("equal_nan=True not supported.")
    return _instance().allclose(a1, a2, rtol=0, atol=0)
